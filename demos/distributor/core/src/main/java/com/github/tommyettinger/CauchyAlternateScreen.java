...
public class CauchyAlternateScreen extends ScreenAdapter {
    private CauchyAlternateDistribution dist;
    ...
    public CauchyAlternateScreen(DistributorDemo main){
        mainGame = main;
    }
    ...
    public void render(float delta) {
        ...
        batch.begin();
        font.draw(batch, Stringf.format("CauchyAlternateDistribution with A=%1.3f, B=%1.3f; median=%1.3f at %d FPS",
        ...
        font.draw(batch,
                "a – alpha; must not be NaN\n" +
                        "b – gamma; should be greater than 0.0", 64, 500-32, 256+128, Align.center, true);
        batch.end();
