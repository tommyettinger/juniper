...
public class ChiScreen extends ScreenAdapter {
    private ChiDistribution dist;
    ...
    public void show() {
        font = mainGame.font;
        try  {
            dist = new ChiDistribution(mainGame.random, (int)a);
        } catch (IllegalArgumentException ignored) {
            dist = new ChiDistribution(mainGame.random, 1);
        }
    ...
    public ChiScreen(DistributorDemo main){
        mainGame = main;
    }
    ...
    public void render(float delta) {
        ...
        batch.begin();
        font.draw(batch, Stringf.format("ChiDistribution with A=%1.3f; mean=%1.3f at %d FPS",
