...
public class ParetoScreen extends ScreenAdapter {
    ...
    public void show() {
        ...
        dist = new ParetoDistribution(a, b);
    ...
    public ParetoScreen(DistributorDemo main){
        mainGame = main;
    }
    ...
    public void render(float delta) {
        ...
        batch.begin();
        font.draw(batch, Stringf.format("ParetoDistribution with A=%1.3f, B=%1.3f; median=%1.3f", a, b,
