...
public class ErlangScreen extends ScreenAdapter {
    ...
    public void show() {
        ...
        try {
            dist = new ErlangDistribution(mainGame.random, (int) a, b);
        }catch (IllegalArgumentException ignored) {
            dist = new ErlangDistribution(mainGame.random, 1, 1.0);
        }
    ...
    public ErlangScreen(DistributorDemo main){
        mainGame = main;
    }
    ...
    public void render(float delta) {
        ...
        batch.begin();
        font.draw(batch, Stringf.format("ErlangDistribution with A=%1.3f, B=%1.3f; at %d FPS",
                        a, b, Gdx.graphics.getFramesPerSecond()),
        ...
        font.draw(batch,
                "a – alpha; will be cast to an int, and should be greater or equal to 1\n" +
                        "b – lambda; should be greater than 0.0", 64, 500-32, 256+128, Align.center, true);
        batch.end();
