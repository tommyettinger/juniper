...
public class StudentsTScreen extends ScreenAdapter {
    private StudentsTDistribution dist;
    ...
    public void show() {
        font = mainGame.font;
        try  {
            dist = new StudentsTDistribution(mainGame.random, (int)a);
        } catch (IllegalArgumentException ignored) {
            dist = new StudentsTDistribution(mainGame.random, 1);
        }
    ...
    public StudentsTScreen(DistributorDemo main){
        mainGame = main;
    }
    ...
    public void render(float delta) {
        ...
        batch.begin();
        font.draw(batch, Stringf.format("StudentsTDistribution with A=%.3f; median=%.3f at %d FPS",
                        a, dist.getMedian(), Gdx.graphics.getFramesPerSecond()),
        ...
        font.draw(batch,
                "a – nu; should be greater than 0.0", 64, 500-32, 256+128, Align.center, true);
        batch.end();
