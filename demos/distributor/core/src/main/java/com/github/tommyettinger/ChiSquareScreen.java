...
public class ChiSquareScreen extends ScreenAdapter {
    private ChiSquareDistribution dist;
    ...
    public void show() {
        ...
        try  {
            dist = new ChiSquareDistribution(mainGame.random, (int)a);
        } catch (IllegalArgumentException ignored) {
            dist = new ChiSquareDistribution(mainGame.random, 1);
        }
    ...
    public ChiSquareScreen(DistributorDemo main){
        mainGame = main;
    }
    ...
    public void render(float delta) {
        ...
        batch.begin();
        font.draw(batch, Stringf.format("ChiSquareDistribution with A=%1.3f; mean=%1.3f at %d FPS",
