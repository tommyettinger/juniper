...
public class CauchyScreen extends ScreenAdapter {
    ...
    public void show() {
        font = mainGame.font;
        try  {
            dist = new CauchyDistribution(mainGame.random, a, b);
        } catch (IllegalArgumentException ignored) {
            dist = new CauchyDistribution(mainGame.random, 0.0, 1.0);
        }
    ...
    public CauchyScreen(DistributorDemo main){
        mainGame = main;
    }
    ...
    public void render(float delta) {
        ...
        batch.begin();
        font.draw(batch, Stringf.format("CauchyDistribution with A=%.3f, B=%.3f; median=%.3f at %d FPS",
