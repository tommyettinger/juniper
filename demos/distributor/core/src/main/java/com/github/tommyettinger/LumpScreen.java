...
public class LumpScreen extends ScreenAdapter {
    private LumpDistribution dist;
    ...
    public void show() {
        ...
        try  {
            dist = new LumpDistribution(new ChopRandom(), a, b);
        } catch (IllegalArgumentException ignored) {
            dist = new LumpDistribution(new ChopRandom(), 0.0, 0.25);
        }
    ...
    public LumpScreen(DistributorDemo main){
        mainGame = main;
    }
...
//            int m = (int) (TrigTools.atan2Turns(dist.generator.nextGaussian(-a, 1.0), dist.generator.nextGaussian(b, 1.0)) * 512);
        ...
        batch.begin();
        font.draw(batch, Stringf.format("LumpDistribution with A=%1.3f, B=%1.3f at %d FPS", a, b,
