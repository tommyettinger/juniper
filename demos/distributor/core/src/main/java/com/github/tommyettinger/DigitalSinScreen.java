...
public class DigitalSinScreen extends ScreenAdapter {
    ...
    public DigitalSinScreen(DistributorDemo main){
        mainGame = main;
    }
    ...
    public void render(float delta) {
        ...
        for (int i = 0; i < 0x40000; i++) {
            int m = (int) (TrigTools.sin(random.nextExclusiveFloat()) * 128 + 128);
            if(m >= 0 && m < 512)
                amounts[m]++;
        }
