package com.github.tommyettinger.ef;
...
public class ChipScreen extends ScreenAdapter {
    private Chip32Random random;
    ...
    public ChipScreen(SpeedDemo main){
        mainGame = main;
    }
