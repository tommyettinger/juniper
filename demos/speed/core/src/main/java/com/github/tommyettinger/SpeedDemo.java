 ...
 * Xoshiro160RoadroxoRandom is usually in the same territory as Xoshiro128PlusPlusRandom, but a bit slower usually.
 * <br>
 * Results on GWT:
 ...
 * Xoshiro160RoadroxoRandom (RARX) performs like Xoshiro128PlusPlusRandom but almost always better; sometimes about the same as Chip and Chop, sometimes faster.
 * AceRandom, as expected on GWT, is quite slow.
 * <br>
 * Results on TeaVM:
 ...
 * Xoshiro160RoadroxoRandom (RARX) is usually faster than Xoshiro128PlusPlusRandom, and on-par withe Chip and Chop. But, nextDouble is slower here, and nextInt is faster.
 * AceRandom, as expected on GWT, is quite slow.
...
/* OLD, used heavy 64-bit math and one state advance for RARX
 * Results on LWJGL3:
 * Chip32Random is often fastest.
 * Xoshiro128PlusPlusRandom sometimes beats Chip32Random by a significant margin, but is usually a little slower.
 * ChopRandom is usually close to the second-place position, but sometimes ties for first.
