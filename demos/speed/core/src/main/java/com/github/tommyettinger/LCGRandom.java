 ...
 * It follows the algorithms specified in the JRE javadoc. The code here is almost
 * exactly copied from GWT's sources, which are Apache-licensed.
 * <br>
 * This is meant to act like java.util.Random, hence the name.
 * <br>
