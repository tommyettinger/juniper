...
public class Bear32RandomBC extends EnhancedRandom {
	/**
	 ...
	 */
	public Bear32RandomBC(long seed) {
		super(seed);
		setSeed(seed);
	}
	 ...
	 */
	public Bear32RandomBC(int stateA, int stateB, int stateC, int stateD) {
		super(stateA);
		this.stateA = stateA;
		this.stateB = stateB;
		this.stateC = stateC;
...
//		return (long)(hi ^ (x << 13 | x >>> 19)) << 32 | (lo & 0xFFFFFFFFL);
	...
	@Override
	public Bear32RandomBC copy () {
		return new Bear32RandomBC(stateA, stateB, stateC, stateD);
	}
	...
	public boolean equals (Object o) {
		...
		Bear32RandomBC that = (Bear32RandomBC)o;
