 ...
 */
public class Bear32RandomJS extends EnhancedRandom {
	/**
	 ...
	 */
	public Bear32RandomJS(long seed) {
		super(seed);
		setSeed(seed);
	}
	 ...
	 */
	public Bear32RandomJS(int stateA, int stateB, int stateC, int stateD) {
		super(stateA);
		this.stateA = stateA;
		this.stateB = stateB;
		this.stateC = stateC;
	...
	public native int nextInt () /*-{
		var x = (this.@com.github.tommyettinger.random.Bear32RandomJS::stateA = 0 | this.@com.github.tommyettinger.random.Bear32RandomJS::stateA + 0x9E3779B9);
		var y = (this.@com.github.tommyettinger.random.Bear32RandomJS::stateB = 0 | this.@com.github.tommyettinger.random.Bear32RandomJS::stateB + (x ^ Math.clz32(x)));
		var z = (this.@com.github.tommyettinger.random.Bear32RandomJS::stateC = 0 | this.@com.github.tommyettinger.random.Bear32RandomJS::stateC + (y ^ Math.clz32(x &= y)));
		var w = (this.@com.github.tommyettinger.random.Bear32RandomJS::stateD = 0 | this.@com.github.tommyettinger.random.Bear32RandomJS::stateD + (z ^ Math.clz32(x &= z)));
		x = Math.imul(w + (x << 13 | x >>> 19), 0x2C1B3C6D);
	...
	public native int previousInt() /*-{
		var x = this.@com.github.tommyettinger.random.Bear32RandomJS::stateA;
		var y = this.@com.github.tommyettinger.random.Bear32RandomJS::stateB;
		var z = this.@com.github.tommyettinger.random.Bear32RandomJS::stateC;
		var w = this.@com.github.tommyettinger.random.Bear32RandomJS::stateD;
		var m = x & y & z;
		m = Math.imul(w + (m << 13 | m >>> 19), 0x2C1B3C6D);
		m = Math.imul(m ^ m >>> 12, 0x297A2D39);
		m ^= m >>> 15;
		this.@com.github.tommyettinger.random.Bear32RandomJS::stateA = 0 | x - 0x9E3779B9;
		this.@com.github.tommyettinger.random.Bear32RandomJS::stateB = 0 | y - (x ^ Math.clz32(x));
		this.@com.github.tommyettinger.random.Bear32RandomJS::stateC = 0 | z - (y ^ Math.clz32(x &= y));
		this.@com.github.tommyettinger.random.Bear32RandomJS::stateD = 0 | w - (z ^ Math.clz32(x &  z));
		return m;
	}-*/;
	...
	@Override
	public Bear32RandomJS copy () {
		return new Bear32RandomJS(stateA, stateB, stateC, stateD);
	}
	...
	public boolean equals (Object o) {
		...
		Bear32RandomJS that = (Bear32RandomJS)o;
