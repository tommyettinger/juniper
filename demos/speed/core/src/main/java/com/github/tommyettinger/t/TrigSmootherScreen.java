...
public class TrigSmootherScreen extends ScreenAdapter {
    ...
    public TrigSmootherScreen(SpeedDemo main){
        mainGame = main;
    }
    ...
    public void render(float delta) {
        ...
        for (int i = 0; i < SpeedDemo.STEPS; i++) {
            int m = (int) (TrigTools.sinSmoother(random.nextFloat() * 512) * 255f + 256f);
            if(m >= 0 && m < 512)
                amounts[m]++;
        }
