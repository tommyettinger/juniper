 ...
 * stream value. PcgRXSMXSRandom implements all optional methods in EnhancedRandom except
...
public class PcgRXSMXSRandom extends EnhancedRandom {
	...
	/**
	 * Creates a new PcgRXSMXSRandom with the given seed; all {@code long} values are permitted.
	 * The seed will be passed to {@link #setSeed(long)} to attempt to adequately distribute the seed randomly.
	 *
	 * @param seed any {@code long} value
	 */
	public PcgRXSMXSRandom(long seed) {
		super(seed);
		setSeed(seed);
	}

	/**
	 * Creates a new PcgRXSMXSRandom with the given two states; all {@code long} values are permitted for
	 ...
	 */
	public PcgRXSMXSRandom(long stateA, long stateB) {
		super(stateA);
		this.stateA = stateA;
