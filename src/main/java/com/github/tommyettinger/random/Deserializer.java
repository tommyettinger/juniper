...
public final class Deserializer {
	...
	static {
		...
		register(new HornRandom(1));
		register(new Mx3Random(1));
		register(new QoaxsrRandom(1));
		register(new WoolRandom(1));
		register(new LCG64Random(1));
		...
		register(new XorShift64QuasiRandom(1));
		...
		register(new Chip32Random(1, 2, 3, 4));
		...
		register(new ThrooshRandom(1, 2, 3, 4));
		...
		register(new InterpolatorWrapper(Interpolations.smooth, 1, 2, 3, 4));
	}
