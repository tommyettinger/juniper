...
//		System.out.println("State after previousLong():\n" + random);
	...
	@Test
	public void testOrbitalPrevious() {
		OrbitalRandom random = new OrbitalRandom(0L);
		long n0 = random.nextLong();
		long n1 = random.nextLong();
		long n2 = random.nextLong();
		long n3 = random.nextLong();
	...
	@Test
	public void testRawr32Previous() {
		Rawr32Random random = new Rawr32Random(0L);
		long n0 = random.nextLong();
		long n1 = random.nextLong();
		long n2 = random.nextLong();
		long n3 = random.nextLong();
