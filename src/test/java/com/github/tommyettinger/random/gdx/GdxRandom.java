...
public abstract class GdxRandom extends Random {
	 ...
	 * different {@code long} values, or {@code int} values, should return
...
//		System.out.println(probit(2.710505431213761E-20));
//		System.out.println(probit(0.9999999999999999));
//	}
}
