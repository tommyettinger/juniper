 ...
 */
public class Amp2XsRandom extends EnhancedRandom {
	...
	/**
	 * Creates a new Amp2XsRandom with a random state.
	 */
	public Amp2XsRandom() {
	...
	/**
	 * Creates a new Amp2XsRandom with the given state; all {@code long} values are permitted.
	 *
	 * @param state any {@code long} value
	 */
	public Amp2XsRandom(long state) {
		super(state);
		this.state = state;
	}
	...
	@Override
	public Amp2XsRandom copy () {
		return new Amp2XsRandom(state);
	}
	...
	public boolean equals (Object o) {
		...
		Amp2XsRandom that = (Amp2XsRandom)o;
	...
	public String toString () {
		return "Amp2XsRandom{state=" + (state) + "L}";
	}
}
