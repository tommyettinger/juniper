 ...
 */
public class SpurRandom extends EnhancedRandom {
	@Override
	...
	/**
	 * Creates a new SpurRandom with a random state.
	 */
	public SpurRandom() {
	...
	/**
	 * Creates a new SpurRandom with the given seed; all {@code long} values are permitted.
	 * The seed will be passed to {@link #setSeed(long)} to attempt to adequately distribute the seed randomly.
	 *
	 * @param seed any {@code long} value
	 */
	public SpurRandom(long seed) {
		setSeed(seed);
	}

	/**
	 * Creates a new SpurRandom with the given two states; all {@code long} values are permitted.
	 * These states will be used verbatim for stateA and stateB. stateC will be assigned 1.
	 *
	 * @param stateA any {@code long} value
	 * @param stateB any {@code long} value
	 */
	public SpurRandom(long stateA, long stateB) {
		this.stateA = stateA;
		this.stateB = stateB;
		this.stateC = 1L;
	}
	...
	/**
	 * Creates a new SpurRandom with the given three states; all {@code long} values are permitted.
	 ...
	 */
	public SpurRandom(long stateA, long stateB, long stateC) {
		this.stateA = stateA;
		this.stateB = stateB;
		this.stateC = stateC;
	}
...
//		a = ((a << 3 | a >>> 61) ^ b);
	...
	public static void main(String[] args) {
		EnhancedRandom random = new SpurRandom(1L);
		{
