 ...
 * <br>
 * Has passed 128TB of PractRand without anomalies.
 * Any individual stream will return
 ...
 */
public class SpiralRandom extends EnhancedRandom {
	...
	/**
	 * Creates a new SpiralRandom with a random state.
	 */
	public SpiralRandom() {
		super();
	...
	/**
	 * Creates a new SpiralRandom with the given seed; all {@code long} values are permitted.
	 * The seed will be passed to {@link #setSeed(long)} to attempt to adequately distribute the seed randomly.
	 *
	 * @param seed any {@code long} value
	 */
	public SpiralRandom(long seed) {
		super(seed);
		setSeed(seed);
	}

	/**
	 * Creates a new SpiralRandom with the given two states; all {@code long} values are permitted for
	 * stateA and for stateB. These states are not changed during assignment.
	 *
	 * @param stateA any {@code long} value
	 * @param stateB any {@code long} value
	 */
	public SpiralRandom(long stateA, long stateB) {
		super(stateA);
		this.stateA = stateA;
		this.stateB = stateB;
	}
...
//	}
	...
	public SpiralRandom copy() {
		return new SpiralRandom(stateA, stateB);
	}
	...
	public boolean equals(Object o) {
		...
		SpiralRandom that = (SpiralRandom) o;

		return stateA == that.stateA && stateB == that.stateB;
	}

	public String toString() {
		return "SpiralRandom{" + "stateA=" + (stateA) + "L, stateB=" + (stateB) + "L}";
	}

	public static void main(String[] args) {
		SpiralRandom random = new SpiralRandom(1L);
		{
