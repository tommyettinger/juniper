 ...
 */
public class I64X256AxRandom extends EnhancedRandom {
	 ...
	 */
	public I64X256AxRandom(long seed) {
		super(seed);
		setSeed(seed);
	}
	 ...
	 */
	public I64X256AxRandom(long stateA, long stateB, long stateC, long stateD, long stateE) {
		super(stateA);
		this.stateA = stateA;
		this.stateB = stateB;
		this.stateC = stateC;
	...
	public long nextLong () {
		long res = ax(stateA, stateE, stateA, stateA);
		++stateE;
		long t = stateB << 17;
		stateC ^= stateA;
		stateD ^= stateB;
	...
	public long previousLong () {
		...
		--stateE;
		return ax(stateA, stateE, stateA, stateA);
	}
...
//		s1 ^= s2; // StateB has b;
	...
	@Override
	public I64X256AxRandom copy () {
		return new I64X256AxRandom(stateA, stateB, stateC, stateD, stateE);
	}
	...
	public boolean equals (Object o) {
		...
		I64X256AxRandom that = (I64X256AxRandom)o;
