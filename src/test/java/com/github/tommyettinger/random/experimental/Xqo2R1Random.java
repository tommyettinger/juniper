...
public class Xqo2R1Random extends EnhancedRandom {
	...
	/**
	 * Creates a new Xqo2R1Random with a random state.
	 */
	public Xqo2R1Random() {
	...
	/**
	 * Creates a new Xqo2R1Random with the given state; all {@code long} values are permitted.
	 *
	 * @param state any {@code long} value
	 */
	public Xqo2R1Random(long state) {
		super(state);
		this.state = state;
	}
	...
	@Override
	public Xqo2R1Random copy () {
		return new Xqo2R1Random(state);
	}
	...
	public boolean equals (Object o) {
		...
		Xqo2R1Random that = (Xqo2R1Random)o;
	...
	public String toString () {
		return "Xqo2R1Random{state=" + (state) + "L}";
	}
}
