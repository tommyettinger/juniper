 ...
 */
public class OC128X256LowMixRandom extends EnhancedRandom {
	...
	/**
	 * Creates a new OC128X256LowMixRandom with a random state.
	 */
	public OC128X256LowMixRandom() {
		super();
	...
	/**
	 * Creates a new OC128X256LowMixRandom with the given seed; all {@code long} values are permitted.
	 * The seed will be passed to {@link #setSeed(long)} to attempt to adequately distribute the seed randomly.
	 *
	 * @param seed any {@code long} value
	 */
	public OC128X256LowMixRandom(long seed) {
		super(seed);
		setSeed(seed);
	}

	/**
	 * Creates a new OC128X256LowMixRandom with the given four states; all {@code long} values are permitted.
	 ...
	 */
	public OC128X256LowMixRandom(long stateA, long stateB, long stateC, long stateD, long stateE, long stateF) {
		super(stateA);
		this.stateA = stateA;
		this.stateB = stateB;
		this.stateC = stateC;
	...
	public long nextLong () {
		long res = (stateE << 41 | stateE >>> 23) ^ stateF;
		stateE += 0xD1B54A32D192ED03L + stateD;
	...
	public long previousLong () {
		...
		stateF -= 0x8CB92BA72F3D8DD7L + BitConversion.countLeadingZeros(stateE);
		stateE -= 0xD1B54A32D192ED03L + stateD;
		return (stateE << 41 | stateE >>> 23) ^ stateF;
	}
	...
	@Override
	public OC128X256LowMixRandom copy () {
		return new OC128X256LowMixRandom(stateA, stateB, stateC, stateD, stateE, stateF);
	}
	...
	public boolean equals (Object o) {
		...
		OC128X256LowMixRandom that = (OC128X256LowMixRandom)o;
	...
	public String toString () {
		return "OC128X256LowMixRandom{" + "stateA=" + (stateA) + "L, stateB=" + (stateB) + "L, stateC=" + (stateC) + "L, stateD=" + (stateD) + "L, stateE=" + (stateE) + "L, stateF=" + (stateF) + "L}";
	}
}
