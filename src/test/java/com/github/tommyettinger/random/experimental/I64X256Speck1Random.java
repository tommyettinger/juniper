 ...
 */
public class I64X256Speck1Random extends EnhancedRandom {
	 ...
	 */
	public I64X256Speck1Random(long seed) {
		super(seed);
		setSeed(seed);
	}
	 ...
	 */
	public I64X256Speck1Random(long stateA, long stateB, long stateC, long stateD, long stateE) {
		super(stateA);
		this.stateA = stateA;
		this.stateB = stateB;
		this.stateC = stateC;
...
//		return a;
	...
	@Override
	public I64X256Speck1Random copy () {
		return new I64X256Speck1Random(stateA, stateB, stateC, stateD, stateE);
	}
	...
	public boolean equals (Object o) {
		...
		I64X256Speck1Random that = (I64X256Speck1Random)o;
