 ...
 */
public class Amp4RotateRandom extends EnhancedRandom {
	...
	/**
	 * Creates a new Amp4RotateRandom with a random state.
	 */
	public Amp4RotateRandom() {
		this(EnhancedRandom.seedFromMath());
	}

	/**
	 * Creates a new Amp4RotateRandom with the given state; all {@code long} values are permitted.
	 *
	 * @param state any {@code long} value
	 */
	public Amp4RotateRandom(long state) {
		super(state);
		this.state = state;
	}
	...
	@Override
	public Amp4RotateRandom copy() {
		return new Amp4RotateRandom(state);
	}
	...
	public boolean equals(Object o) {
		...
		Amp4RotateRandom that = (Amp4RotateRandom) o;
	...
	public String toString() {
		return "Amp4RotateRandom{state=" + (state) + "L}";
	}
}
