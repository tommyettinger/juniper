...
/**
 * An LXM generator with the Mix step changed to 2 rounds of the
 * <a href="https://en.wikipedia.org/wiki/Speck_(cipher)">Speck Cipher</a>.
 ...
 */
public class L64X256Speck2Random extends EnhancedRandom {
	...
	/**
	 * Creates a new L64X256Speck2Random with a random state.
	 */
	public L64X256Speck2Random() {
		super();
	...
	/**
	 * Creates a new L64X256Speck2Random with the given seed; all {@code long} values are permitted.
	 * The seed will be passed to {@link #setSeed(long)} to attempt to adequately distribute the seed randomly.
	 *
	 * @param seed any {@code long} value
	 */
	public L64X256Speck2Random(long seed) {
		super(seed);
		setSeed(seed);
	}

	/**
	 * Creates a new L64X256Speck2Random with the given four states; all {@code long} values are permitted.
	 ...
	 */
	public L64X256Speck2Random(long stateA, long stateB, long stateC, long stateD, long stateE) {
		super(stateA);
		this.stateA = stateA;
		this.stateB = stateB;
		this.stateC = stateC;
...
//		s1 ^= s2; // StateB has b;
		...
		return speck(s0, ((stateE - 1L) * 0x572B5EE77A54E3BDL));
	}
...
//		return ((a << 3 | a >>> 61) ^ (((b << 56 | b >>> 8) + a ^ C)));
	...
	@Override
	public L64X256Speck2Random copy() {
		return new L64X256Speck2Random(stateA, stateB, stateC, stateD, stateE);
	}
	...
	public boolean equals(Object o) {
		...
		L64X256Speck2Random that = (L64X256Speck2Random) o;
	...
	public String toString() {
		return "L64X256Speck2Random{" + "stateA=" + (stateA) + "L, stateB=" + (stateB) + "L, stateC=" + (stateC) + "L, stateD=" + (stateD) + "L, stateE=" + (stateE) + "L}";
	}
}
