 ...
 * counter (increment by 1). This is related to L64X256MixRandom in JDK 17 and newer.
 * <br>
 ...
 */
public class C64X256Speck2Random extends EnhancedRandom {
	...
	/**
	 * Creates a new C64X256Speck2Random with a random state.
	 */
	public C64X256Speck2Random() {
		super();
	...
	/**
	 * Creates a new C64X256Speck2Random with the given seed; all {@code long} values are permitted.
	 * The seed will be passed to {@link #setSeed(long)} to attempt to adequately distribute the seed randomly.
	 *
	 * @param seed any {@code long} value
	 */
	public C64X256Speck2Random(long seed) {
		super(seed);
		setSeed(seed);
	}

	/**
	 * Creates a new C64X256Speck2Random with the given four states; all {@code long} values are permitted.
	 ...
	 */
	public C64X256Speck2Random(long stateA, long stateB, long stateC, long stateD, long stateE) {
		super(stateA);
		this.stateA = stateA;
		this.stateB = stateB;
		this.stateC = stateC;
...
//		s1 ^= s2; // StateB has b;
		...
		return speck(s0, stateE - 0xD1342543DE82EF95L);
	}
...
//		return ((a << 3 | a >>> 61) ^ (((b << 56 | b >>> 8) + a ^ C)));
	...
	@Override
	public C64X256Speck2Random copy () {
		return new C64X256Speck2Random(stateA, stateB, stateC, stateD, stateE);
	}
	...
	public boolean equals (Object o) {
		...
		C64X256Speck2Random that = (C64X256Speck2Random)o;
	...
	public String toString () {
		return "C64X256Speck2Random{" + "stateA=" + (stateA) + "L, stateB=" + (stateB) + "L, stateC=" + (stateC) + "L, stateD=" + (stateD) + "L, stateE=" + (stateE) + "L}";
	}
}
