 ...
 */
public class Amp3RotateRandom extends EnhancedRandom {
	...
	/**
	 * Creates a new Amp3RotateRandom with a random state.
	 */
	public Amp3RotateRandom() {
		this(EnhancedRandom.seedFromMath());
	}

	/**
	 * Creates a new Amp3RotateRandom with the given state; all {@code long} values are permitted.
	 *
	 * @param state any {@code long} value
	 */
	public Amp3RotateRandom(long state) {
		super(state);
		this.state = state;
	}
	...
	@Override
	public Amp3RotateRandom copy() {
		return new Amp3RotateRandom(state);
	}
	...
	public boolean equals(Object o) {
		...
		Amp3RotateRandom that = (Amp3RotateRandom) o;
	...
	public String toString() {
		return "Amp3RotateRandom{state=" + (state) + "L}";
	}
}
