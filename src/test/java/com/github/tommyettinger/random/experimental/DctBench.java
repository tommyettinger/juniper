...
import com.github.tommyettinger.function.ObjSameBiConsumer;
import com.github.tommyettinger.random.Dct;
import com.github.tommyettinger.random.Fft;
...
/**
 */
public class DctBench extends ApplicationAdapter {

    public static String title = "";
    public static int dctMode = 0;
    public static int dctMax = 4;
    public static ObjectList<ObjSameBiConsumer<double[][]>> transforms =
            ObjectList.with(DctChoice::transform2DTable, DctChoice::transform2DMath,
                    DctChoice::transform2DSmooth, DctChoice::transform2DSmoother);
                ...
                switch (keycode) {
                    ...
                    case ENTER:
                        ...
                        title = randoms[currentRandom][0][0].getClass().getSimpleName()
                                + " dct " + dctMode + " mode " + currentMode + " bit " + selectedBit;
                    ...
                    case DOWN: // mode
                        ...
                        break;
                    case D:
                        dctMode = ((dctMode + (UIUtils.shift() ? dctMax - 1 : 1)) % dctMax);
                        refreshGrid();
                        title = randoms[currentRandom][0][0].getClass().getSimpleName()
                                + " dct " + dctMode + " mode " + currentMode + " bit " + selectedBit;
                        System.out.println(title);
    ...
    public void putMap() {
        ...
        transforms.get(dctMode).accept(real, imag);
    ...
    public static void main(String[] arg) {
        ...
        new Lwjgl3Application(new DctBench(), config);
    }
}
