 ...
 */
public class BarleyRandom extends EnhancedRandom {
	@Override
	...
	/**
	 * Creates a new BarleyRandom with a random state.
	 */
	public BarleyRandom() {
	...
	/**
	 * Creates a new BarleyRandom with the given seed; all {@code long} values are permitted.
	 * The seed will be passed to {@link #setSeed(long)} to attempt to adequately distribute the seed randomly.
	 *
	 * @param seed any {@code long} value
	 */
	public BarleyRandom(long seed) {
		setSeed(seed);
	}

	/**
	 * Creates a new BarleyRandom with the given two states; all {@code long} values are permitted.
	 * These states will be used verbatim.
	 *
	 * @param stateA any {@code long} value
	 * @param stateB any {@code long} value
	 */
	public BarleyRandom(long stateA, long stateB) {
		this.stateA = stateA;
		this.stateB = stateB;
	}
	...
	public static void main(String[] args) {
		EnhancedRandom random = new BarleyRandom(1L);
		{
