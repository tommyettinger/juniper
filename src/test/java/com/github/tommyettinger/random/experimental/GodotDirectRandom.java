 ...
 * generator... But, this generator doesn't use the recommended/required seeding routine used for the two states.
 * It is quite close, and still ensures that {@code inc} is odd (by disregarding the sign bit), but doesn't alter
 * {@code state} at all from its initial seed. This actually does slightly better at avoiding noticeable correlation
 * when compared at certain points in the generated sequences to {@link GodotRandom}, which <em>does</em> use the PCG32
 * XSH RR recommended/required seeding routine.
 * <br>
 * Note frame 61 in {@link com.github.tommyettinger.random.CorrelationVisualizer}, for example:
 * <ul>
 *     <li><a href="https://i.imgur.com/FpKzZzX.png">This generator at frame 61.</a></li>
 *     <li><a href="https://i.imgur.com/U6VoLS0.png">GodotRandom at frame 61.</a></li>
 * </ul>
 *
 */
public class GodotDirectRandom extends EnhancedRandom {
	 ...
	 */
	public GodotDirectRandom(long seed) {
