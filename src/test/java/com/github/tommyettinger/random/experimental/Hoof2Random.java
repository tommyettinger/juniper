 ...
 */
public class Hoof2Random extends EnhancedRandom {
	...
	/**
	 * Creates a new Hoof2Random with a random state.
	 */
	public Hoof2Random() {
		super();
	...
	/**
	 * Creates a new Hoof2Random with the given seed; all {@code long} values are permitted.
	 * The seed will be passed to {@link #setSeed(long)} to attempt to adequately distribute the seed randomly.
	 *
	 * @param seed any {@code long} value
	 */
	public Hoof2Random(long seed) {
		super(seed);
		setSeed(seed);
	}

	/**
	 * Creates a new Hoof2Random with the given two states; all {@code long} values are permitted except 0 for
	 ...
	 */
	public Hoof2Random(long stateA, long stateB) {
		super(stateA);
		this.stateA = stateA;
		this.stateB = stateB;
		if (stateA == 0L)
	...
	public static void main(String[] args) {
		Hoof2Random random = new Hoof2Random(1L);
		{
