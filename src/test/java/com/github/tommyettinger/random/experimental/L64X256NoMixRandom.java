...
public class L64X256NoMixRandom extends EnhancedRandom {
	...
	public long leap()
	{
		...
		return s0 + (stateE * 0xD1342543DE82EF95L + 1L);
	}
	...
	public String toString () {
		return "L64X256NoMixRandomL64X256NoMixRandom{" + "stateA=" + (stateA) + "L, stateB=" + (stateB) + "L, stateC=" + (stateC) + "L, stateD=" + (stateD) + "L, stateE=" + (stateE) + "L}";
	}
}
