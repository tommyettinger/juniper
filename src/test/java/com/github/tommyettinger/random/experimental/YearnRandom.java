 ...
 * This is a modified version of {@link YarnRandom} meant to work in GDScript and be less correlated.
 */
public class YearnRandom extends EnhancedRandom {
	...
	/**
	 * Creates a new YearnRandom with a random state.
	 */
	public YearnRandom() {
	...
	/**
	 * Creates a new YearnRandom with the given state; all {@code long} values are permitted.
	 *
	 * @param state any {@code long} value
	 */
	public YearnRandom(long state) {
		super(state);
		this.state = state;
	}
	...
	@Override
	public YearnRandom copy() {
		return new YearnRandom(state);
	}
	...
	public boolean equals(Object o) {
		...
		YearnRandom that = (YearnRandom) o;
	...
	public String toString() {
		return "YearnRandom{state=" + (state) + "L}";
	}
}
