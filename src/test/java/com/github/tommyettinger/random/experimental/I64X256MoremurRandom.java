...
/**
 * An LXM generator with the Mix step changed to Moremur and the LCG step changed to an additive counter (increment by
 * 1). This is related to L64X256MixRandom in JDK 17 and newer.
 * <br>
 ...
 */
public class I64X256MoremurRandom extends EnhancedRandom {
	 ...
	 */
	public I64X256MoremurRandom(long seed) {
		super(seed);
		setSeed(seed);
	}
	 ...
	 */
	public I64X256MoremurRandom(long stateA, long stateB, long stateC, long stateD, long stateE) {
		super(stateA);
		this.stateA = stateA;
		this.stateB = stateB;
		this.stateC = stateC;
