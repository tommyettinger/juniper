 ...
 */
public class I64LFSR64MoremurRandom extends EnhancedRandom {
	 ...
	 */
	public I64LFSR64MoremurRandom(long seed) {
		super(seed);
		setSeed(seed);
	}
	 ...
	 */
	public I64LFSR64MoremurRandom(long stateA, long stateB) {
		super(stateA);
		this.stateA = stateA;
		this.stateB = stateB;
		if (stateA == 0L)
	...
	@Override
	public I64LFSR64MoremurRandom copy() {
		return new I64LFSR64MoremurRandom(stateA, stateB);
	}
	...
	public boolean equals(Object o) {
		...
		I64LFSR64MoremurRandom that = (I64LFSR64MoremurRandom) o;
