 ...
 */
public class Taxman32Random extends EnhancedRandom {
    /**
     ...
     */
    public Taxman32Random(long seed) {
        super(seed);
        setSeed(seed);
    }
     ...
     */
    public Taxman32Random(int stateA, int stateB) {
        super(stateA);
        this.stateA = stateA;
        this.stateB = stateB;
    }
    ...
    @Override
    public Taxman32Random copy() {
        return new Taxman32Random(stateA, stateB);
    }
    ...
    public boolean equals(Object o) {
        ...
        Taxman32Random that = (Taxman32Random) o;
    ...
    public static void main(String[] args) {
        Taxman32Random random = new Taxman32Random(1L);
