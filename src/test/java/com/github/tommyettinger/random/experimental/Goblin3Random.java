 ...
 * <br>
 * This is the 3-long-state version of the Goblin generator.
 */
public class Goblin3Random extends EnhancedRandom {
	@Override
	...
	/**
	 * Creates a new Goblin3Random with a random state.
	 */
	public Goblin3Random() {
	...
	/**
	 * Creates a new Goblin3Random with the given seed; all {@code long} values are permitted.
	 * The seed will be passed to {@link #setSeed(long)} to attempt to adequately distribute the seed randomly.
	 *
	 * @param seed any {@code long} value
	 */
	public Goblin3Random(long seed) {
		setSeed(seed);
	}

	/**
	 * Creates a new Goblin3Random with the given two states; all {@code long} values are permitted.
	 * These states will be used verbatim for stateA and stateB. stateC will be assigned 1.
	 *
	 * @param stateA any {@code long} value
	 * @param stateB any {@code long} value
	 */
	public Goblin3Random(long stateA, long stateB) {
		this.stateA = stateA;
		this.stateB = stateB;
		this.stateC = 1L;
	}
	...
	/**
	 * Creates a new Goblin3Random with the given three states; all {@code long} values are permitted.
	 ...
	 */
	public Goblin3Random(long stateA, long stateB, long stateC) {
		this.stateA = stateA;
		this.stateB = stateB;
		this.stateC = stateC;
	}
	...
	public long nextLong() {
		...
		long b = (stateB += 0xC13FA9A902A6328FL + a + BitConversion.countLeadingZeros(a));
		long x = (stateC += 0xD1B54A32D192ED03L + b + BitConversion.countLeadingZeros(a & b));
		x ^= x >>> 27;
	...
	public long previousLong() {
		...
		stateB -= 0xC13FA9A902A6328FL + a + BitConversion.countLeadingZeros(a);
		stateC -= 0xD1B54A32D192ED03L + b + BitConversion.countLeadingZeros(a & b);
		x ^= x >>> 27;
		x *= 0x3C79AC492BA7B653L;
		x ^= x >>> 33;
		x *= 0x1C69B3F74AC4AE35L;
	...
	@Override
	public Goblin3Random copy() {
		return new Goblin3Random(stateA, stateB, stateC);
	}
	...
	public boolean equals(Object o) {
		...
		Goblin3Random that = (Goblin3Random) o;

		return stateA == that.stateA && stateB == that.stateB && stateC == that.stateC;
	}

	public String toString() {
		return "Goblin3Random{" + "stateA=" + (stateA) + "L, stateB=" + (stateB) + "L, stateC=" + (stateC) + "L}";
	}

	public static void main(String[] args) {
		EnhancedRandom random = new Goblin3Random(1L);
		{
