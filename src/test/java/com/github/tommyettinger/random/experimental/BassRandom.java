...
public class BassRandom extends EnhancedRandom {
	...
	/**
	 * Creates a new BassRandom with a random state.
	 */
	public BassRandom() {
	...
	/**
	 * Creates a new BassRandom with the given seed; all {@code long} values are permitted.
	 * The seed will be passed to {@link #setSeed(long)} to attempt to adequately distribute the seed randomly.
	 *
	 * @param seed any {@code long} value
	 */
	public BassRandom(long seed) {
		setSeed(seed);
	}

	/**
	 * Creates a new BassRandom with the given four states; all {@code long} values are permitted.
	 ...
	 */
	public BassRandom(long stateA, long stateB, long stateC, long stateD, long stateE) {
		this.stateA = stateA;
		this.stateB = stateB;
		this.stateC = stateC;
		this.stateD = stateD;
