 ...
 * L64X256MixRandom in JDK 17 and newer.
 * <br>
 ...
 */
public class L64X64PcgRandom extends EnhancedRandom {
	...
	/**
	 * Creates a new L64X64PcgRandom with a random state.
	 */
	public L64X64PcgRandom() {
		super();
	...
	/**
	 * Creates a new L64X64PcgRandom with the given seed; all {@code long} values are permitted.
	 * The seed will be passed to {@link #setSeed(long)} to attempt to adequately distribute the seed randomly.
	 *
	 * @param seed any {@code long} value
	 */
	public L64X64PcgRandom(long seed) {
		super(seed);
		setSeed(seed);
	}

	/**
	 * Creates a new L64X64PcgRandom with the given two states; all {@code long} values are permitted except 0 for
	 ...
	 */
	public L64X64PcgRandom(long stateA, long stateB) {
		super(stateA);
		this.stateA = stateA;
		this.stateB = stateB;
		if (stateA == 0L)
	...
	@Override
	public L64X64PcgRandom copy () {
		return new L64X64PcgRandom(stateA, stateB);
	}
	...
	public boolean equals (Object o) {
		...
		L64X64PcgRandom that = (L64X64PcgRandom)o;
	...
	public String toString () {
		return "L64X64PcgRandom{" + "stateA=" + (stateA) + "L, stateB=" + (stateB) + "L}";
	}
}
