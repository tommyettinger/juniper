 ...
 * and has a period of 2 to the 128. It is perfectly 1D-equidistributed. It passes 128TB of PractRand with no anomalies.
 * <br>
 * The name is because it involves count-leading-zeros (Z) operations and seems to adequately "cook" the inputs.
 */
public class SizzleRandom extends EnhancedRandom {
	...
	/**
	 * Creates a new SizzleRandom with a random state.
	 */
	public SizzleRandom() {
		super();
	...
	/**
	 * Creates a new SizzleRandom with the given seed; all {@code long} values are permitted.
	 * The seed will be passed to {@link #setSeed(long)} to attempt to adequately distribute the seed randomly.
	 *
	 * @param seed any {@code long} value
	 */
	public SizzleRandom(long seed) {
		super(seed);
		setSeed(seed);
	}

	/**
	 * Creates a new SizzleRandom with the given two states; all {@code long} values are permitted for
	 * stateA and for stateB. These states are not changed.
	 *
	 * @param stateA any {@code long} value
	 * @param stateB any {@code long} value
	 */
	public SizzleRandom(long stateA, long stateB) {
		super(stateA);
		this.stateA = stateA;
		this.stateB = stateB;
	}
	...
	@Override
	public SizzleRandom copy() {
		return new SizzleRandom(stateA, stateB);
	}
	...
	public boolean equals(Object o) {
		...
		SizzleRandom that = (SizzleRandom) o;
	...
	public String toString() {
		return "SizzleRandom{" + "stateA=" + (stateA) + "L, stateB=" + (stateB) + "L}";
	}

	public static void main(String[] args) {
		SizzleRandom random = new SizzleRandom(1L);
		{
