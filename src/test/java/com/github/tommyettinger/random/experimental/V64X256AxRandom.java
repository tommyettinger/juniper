 ...
 */
public class V64X256AxRandom extends EnhancedRandom {
	...
	/**
	 * Creates a new V64X256AxRandom with a random state.
	 */
	public V64X256AxRandom() {
		super();
	...
	/**
	 * Creates a new V64X256AxRandom with the given seed; all {@code long} values are permitted.
	 * The seed will be passed to {@link #setSeed(long)} to attempt to adequately distribute the seed randomly.
	 *
	 * @param seed any {@code long} value
	 */
	public V64X256AxRandom(long seed) {
		super(seed);
		setSeed(seed);
	}

	/**
	 * Creates a new V64X256AxRandom with the given four states; all {@code long} values are permitted.
	 ...
	 */
	public V64X256AxRandom(long stateA, long stateB, long stateC, long stateD, long stateE) {
		super(stateA);
		this.stateA = stateA;
		this.stateB = stateB;
		this.stateC = stateC;
	...
	public long nextLong () {
		long res = stateE;
		stateE += ax(stateA, stateB, stateC, stateD);
		long t = stateB << 17;
		stateC ^= stateA;
		stateD ^= stateB;
		stateB ^= stateC;
	...
	public long previousLong () {
		...
		return stateE -= ax(stateA, stateB, stateC, stateD);
	}
	...
	public long leap()
	{
		...
		return stateE - ax(s0, s1, s2, s3);
	}

	/**
	 * A 64-bit probable prime, found with {@link java.math.BigInteger#probablePrime(int, Random)}.
	 */
	private static final long Q = 0xD1B92B09B92266DDL;
	/**
	 * A 64-bit probable prime, found with {@link java.math.BigInteger#probablePrime(int, Random)}.
	 */
	private static final long R = 0x9995988B72E0D285L;
	/**
	 * A 64-bit probable prime, found with {@link java.math.BigInteger#probablePrime(int, Random)}.
	 */
	private static final long S = 0x8FADF5E286E31587L;
	/**
	 * A 64-bit probable prime, found with {@link java.math.BigInteger#probablePrime(int, Random)}.
	 */
	private static final long T = 0xFCF8B405D3D0783BL;

	public static long ax(long a, long b, long c, long d) {
	...
	@Override
	public V64X256AxRandom copy () {
		return new V64X256AxRandom(stateA, stateB, stateC, stateD, stateE);
	}
	...
	public boolean equals (Object o) {
		...
		V64X256AxRandom that = (V64X256AxRandom)o;
	...
	public String toString () {
		return "V64X256AxRandom{" + "stateA=" + (stateA) + "L, stateB=" + (stateB) + "L, stateC=" + (stateC) + "L, stateD=" + (stateD) + "L, stateE=" + (stateE) + "L}";
	}
}
